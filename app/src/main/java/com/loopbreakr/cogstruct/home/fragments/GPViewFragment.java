...
public class GPViewFragment extends Fragment {

    public GPViewFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.home_fragment_gp_view, container, false);
    }
    ...
    private void setBeginButton(View view) {
        Button beginButton = view.findViewById(R.id.gp_begin_button);
        beginButton.setOnClickListener(v -> openActivity());
    }

    private void openActivity(){
        Intent intent = new Intent(this.requireActivity(), GPActivity.class);
