...
public class BIViewFragment extends Fragment {

    public BIViewFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.home_fragment_bi_view, container, false);
    }
    @Override
    ...
    private void setBeginButton(View view) {
        Button beginButton = view.findViewById(R.id.bi_begin_button);
        beginButton.setOnClickListener(v -> openActivity());
    }

    private void openActivity(){
        Intent intent = new Intent(this.requireActivity(), BIActivity.class);
